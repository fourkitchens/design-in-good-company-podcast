...
export function AudioPlayer() {
  ...
  return (
    <div className="flex items-center gap-6 bg-white/90 px-4 py-4 shadow shadow-kitchensKelly-200/80 ring-1 ring-kitchensKelly-900/5 backdrop-blur-sm md:px-6">
